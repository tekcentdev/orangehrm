...
# === Cleanup local backups older than 21 days ===
echo "[INFO] Cleaning up old local backups older than 21 days..."
find "$BACKUP_DIR" -name "orangehrm_full_backup_${OHRM_ENV}_*.tar.gz.enc" -mtime +21 -delete
echo "[INFO] Old local backups removed."
